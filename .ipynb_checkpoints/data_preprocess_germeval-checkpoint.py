...
def parse_args():
    ...
    # Required parameters
    parser.add_argument('--data_path', type=str, default='./data/germeval',
                        help='Directory of where germeval data held.')
...
def main():
    ...
    train_file='germeval_train.xml'
    test_file='germeval_test.xml'
